...
#
# PURPOSE:   Reports image overlap from a directory of aerial photos that contata.
#
...
"""Reports image overlap from a directory of aerial photos that contata."""

# %module
# % description: Reports image overlap from a directory of aerial photos that contata.
# % keyword: raster
# % keyword: algebra
# % keyword: random
# %end
